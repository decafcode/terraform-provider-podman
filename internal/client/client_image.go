...
func (c *Client) ImageInspect(ctx context.Context, nameOrId string) (*api.ImageJson, error) {
	var out *api.ImageJson
	path := fmt.Sprintf("v5.0.0/libpod/images/%s/json", url.PathEscape(nameOrId))
